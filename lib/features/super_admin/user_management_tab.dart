...
class _UserManagementTabState extends State<UserManagementTab> {
  ...
  Future<String?> _getUserGroupDetails(String userId) async {
    try {
      ...
      if (userGroups.isNotEmpty) {
        return userGroups.first.id;
      } else {
        debugPrint('No groups found for user $userId');
        return null;
      }
    } catch (_) {
  ...
  void _showError(String message) => CustomNotification.show(
    context: context,
    message: message,
    type: NotificationType.error,
  );

  void _showSuccess(String message) => CustomNotification.show(
    context: context,
    message: message,
    type: NotificationType.success,
  );

  void _showInfo(String message) => CustomNotification.show(
    context: context,
    message: message,

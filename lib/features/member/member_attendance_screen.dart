...
class _MemberAttendanceScreenState extends State<MemberAttendanceScreen> {
  ...
  Future<void> _loadMemberData() async {
    try {
      ...
      _isActive = _attendedEvents.any(
        (event) => event.dateTime.isAfter(thirtyDaysAgo),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'Member Attendance', showBackButton: true),
      body:
          _isLoading
              ...
              : SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Missed Events', style: TextStyles.heading2),
                    const SizedBox(height: 16),
                    ...
                    Text('Attended Events', style: TextStyles.heading2),
                    const SizedBox(height: 16),
